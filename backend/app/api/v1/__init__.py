...
from app.api.v1 import contact_us
from app.api.v1 import getcurrency
...
api_router.include_router(contact_us.router, tags=["contact-us"])
api_router.include_router(getcurrency.router, tags=["currencies"])
