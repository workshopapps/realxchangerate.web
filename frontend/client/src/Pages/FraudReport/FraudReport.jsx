  ...
  return (
    <Box
      sx={{
        width: "100%",
        bgcolor: "#00296B",
        height: { xs: "111px", sm: "200px" },
        marginBottom:{xs:'32px', sm:'56px'}
      }}
    >
      <Box
        sx={{
  ...
  return (
    <a href={link}>
      ...
      <Body2Text
        ...
        component="p"
      >
        {link.includes("mailto:") ? link.split("mailto:")[1] : link}
      </Body2Text>
    </a>
  );
};
        ...
        >
          ...
          <Left sx={{}}>
            <Box>
              ...
              >
                By focusing on providing the best user experience, Street rates
                has earned a trusted brand name. Unfortunately, unscruptulous
                people sometimes try to use the StreetRates website for fraud.
                Below are a few ways to avoid and report fraud.
              </Body2Text>
            </Box>
